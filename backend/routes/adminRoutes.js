...
const { getPendingUsers, getApprovedUsers, approveUser, rejectUser, getAdminProfile, updateAdminProfile, getAllTransactions } = require('../controllers/adminController');
