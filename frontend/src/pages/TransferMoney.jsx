                ...
                >
                  {!transferSuccessState ? (
                    <div className="flex flex-col items-center w-full max-w-full h-full justify-between py-2">
                      ...
                      {/* Prominent Lottie Animation (Paper Plane Money Transfer) */}
                      <div className="flex items-center justify-center w-full h-[220px] my-auto overflow-hidden">
                        <DotLottieReact
                          src="https://lottie.host/d4ad9495-f8af-47e9-8fb5-b026d8033d1f/0qrix7eq3O.lottie"
                          loop
                          autoplay
                          style={{ width: '220px', height: '220px', maxWidth: '100%', maxHeight: '100%' }}
                        />
                      </div>
